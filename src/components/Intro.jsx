        ...
        <div className="row intro">
            <div className="d-flex flex-column align-items-center">
                ...
                <div className="container">
                    ...
                    <div>
                        <a href= "mailto: jessianne001@email.com"> jessianne001@email.com</a>   |   <a target="_blank" href= "https://www.linkedin.com/in/jessica-hotsko-a487352a3/">LinkedIn</a>   |   <a target="_blank" href= "https://github.com/hotskoj">GitHub</a>
                    </div>
                </div>
            </div>
        </div>
